...
#ifndef _GxEPD2_750c_F19_H_
#define _GxEPD2_750c__F19H_

#include "../GxEPD2_EPD.h"

class GxEPD2_750c_F19 : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 640;
    static const uint16_t HEIGHT = 384;
    static const GxEPD2::Panel panel = GxEPD2::WFD0750BF19;
    ...
    static const uint16_t full_refresh_time = 39000; // ms, e.g. 31094507us
    static const uint16_t partial_refresh_time = 39000; // ms, e.g. 31094507us
    // constructor
    GxEPD2_750c_F19(int8_t cs, int8_t dc, int8_t rst, int8_t busy);
    // methods (virtual)
  ...
  private:
    ...
    void _Update_Full();
    void _Update_Part();
	void _send_lut(uint8_t lut[]);
	void _send_empty_lut(uint8_t lut);
};
