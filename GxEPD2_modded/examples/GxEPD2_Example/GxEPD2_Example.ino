...
///*+++++++++*/GxEPD2_3C<GxEPD2_1160c, GxEPD2_1160c::HEIGHT / 2> display(GxEPD2_1160c(/*CS=5*/ SS, /*DC=*/ 17, /*RST=*/ 16, /*BUSY=*/ 4));
///*+++++++++*/GxEPD2_3C<GxEPD2_750c_F19, GxEPD2_750c_F19::HEIGHT> display(GxEPD2_750c_F19(/*CS=5*/ SS, /*DC=*/ 17, /*RST=*/ 16, /*BUSY=*/ 4));
// 7-color e-paper
